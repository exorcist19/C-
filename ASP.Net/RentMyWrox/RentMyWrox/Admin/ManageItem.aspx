<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms.Master" AutoEventWireup="true" CodeBehind="ManageItem.aspx.cs" Inherits="RentMyWrox.Admin.ManageItem" 
    MetaTagDescription="Manage the items that are avilable to be checked out from the library"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="dataentry">
        ...
        <asp:TextBox runat="server" ID="tbDescription" TextMode="MultiLine" Rows="5" OnTextChanged="tbDescription_TextChanged" Width="216px" />
    ...
    <div class="dataentry">
        ...
        <asp:TextBox runat="server" ID="tbItemNumber" Height="16px" Width="195px" />
    </div>
    <div class="dataentry">
